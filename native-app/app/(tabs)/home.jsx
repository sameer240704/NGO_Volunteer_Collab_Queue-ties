...
const Home = () => {
  ...
  const admins = [
    {
      id: 1,
      primaryImage: "https://randomuser.me/api/portraits/men/1.jpg",
      name: "John Doe",
    },
    {
      id: 2,
      primaryImage: "https://randomuser.me/api/portraits/men/2.jpg",
      name: "Jane Smith",
    },
    {
      id: 3,
      primaryImage: "https://randomuser.me/api/portraits/men/3.jpg",
      name: "Alice Johnson",
    },
    {
      id: 4,
      primaryImage: "https://randomuser.me/api/portraits/women/4.jpg",
      name: "Michael Brown",
    },
    {
      id: 5,
      primaryImage: "https://randomuser.me/api/portraits/women/5.jpg",
      name: "Emily Davis",
    },
    {
      id: 6,
      primaryImage: "https://randomuser.me/api/portraits/men/6.jpg",
      name: "Daniel Wilson",
    },
  ];
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-100">
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        {userData.role === "volunteer" && <TopAdmins admins={admins} />}
      </ScrollView>
    </SafeAreaView>
  );
};
